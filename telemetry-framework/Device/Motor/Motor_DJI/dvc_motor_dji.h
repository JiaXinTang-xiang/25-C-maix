...
{
    uint16_t Encoder_Reverse;   //编码器反向, 处理大小端后为uint16_t
    int16_t Omega_Reverse;      //角速度反向, 处理大小端后为int16_t
    int16_t Current_Reverse;    //电流反向, 处理大小端后为int16_t
...
public:
    ...
    void Init(CAN_HandleTypeDef *hcan, Enum_Motor_DJI_ID __CAN_Rx_ID, Enum_Motor_DJI_Control_Method __Motor_DJI_Control_Method = Motor_DJI_Control_Method_ANGLE, 
			  int32_t __Encoder_Offset = 0, Enum_Motor_DJI_GM6020_Driver_Version __Drive_Version = Motor_DJI_GM6020_Driver_Version_DEFAULT, 
